...
setInterval(() => {
  http.get(`http://americasystem.glitch.me/`);
}, 280000);
...
client.user.setGame(`&help | America Server `,"https://www.twitch.tv/dggamingbot")
...
client.on('message', function(message) {
  var prefix = "&"
    ...
    message.channel.sendMessage(' '+ "**```" + messagesDeleted + " " +  ' رسالة تم مسحها ' + "```**").then(m => m.delete(5000));
    })
    } else {
    let messagecount = parseInt(args[1]);
    message.channel.fetchMessages({limit: messagecount}).then(messages => message.channel.bulkDelete(messages));
    message.channel.sendMessage(' '+ "**```fix\n" + args[1] + " " +  'رسالة تم مسحها' + "```**").then(m => m.delete(5000));
...
message.channel.send(`**بيووو رحلة مجانية خارج السيرفر :joy: **`)
...
const developers = ["473500213072494594","444126346676011028"]
client.on('message', message => {
...
client.on("message", message => {
 if (message.content === "&help") {
  const embed = new Discord.RichEmbed() 
      ...
      .setDescription(`
                    **اوامر البوت**
${prefix}ban __:__ لاعطاء لشخص ركلة من السيرفر
${prefix}kick __:__ لاعطاء شخص طرد لمدة ثانية واحدة من السيرفر
${prefix}mc __:__ لقفل الروم الكتابي
${prefix}umc __:__ لفتح الروم الكتابي
${prefix}clear __:__ لمسح الشات
${prefix}link __:__ لانشاء رابط انفايت لمدة يوم واحد
${prefix}server __:__ لعرض معلومات السيرفر
${prefix}mute __:__ لاعطاء شخص محدد ميوت
${prefix}unmute __:__ لفك ميوت عن شخص محدد
${prefix}avatar __:__ لعرض صورة شخص ما
${prefix}ping __:__ لعرض البنق الخاص بك
`)
